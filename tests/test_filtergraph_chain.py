...
@pytest.mark.parametrize(
    ...
    [
        ...
        (operator.__rshift__, fgb.Chain("split"), (None, '[over]', "[base][over]overlay"), "split[over];[base][over]overlay"),
        (operator.__rshift__, "hflip", fgb.Chain("overlay"), "hflip[L0];[L0]overlay"),
        (operator.__rshift__, ("split",1), fgb.Chain("overlay"), "split[L0];[L0]overlay"),
        (operator.__rshift__, ("split",(0,1)), fgb.Chain("overlay"), "split[L0];[L0]overlay"),
        (operator.__rshift__, ("split[out]",1), fgb.Chain("overlay"), "split[out];[out]overlay"),
        (operator.__rshift__, ("split[out]", '[out]',None), fgb.Chain("overlay"), "split[out];[out]overlay"),
