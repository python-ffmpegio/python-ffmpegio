...
@pytest.mark.parametrize(
    ...
    [
        ...
        (operator.__rshift__, fgb.Chain("split"), (1, "[in]overlay"), "[UNC0]split[UNC2][in];[in][UNC1]overlay[UNC3]"),
        (operator.__rshift__, fgb.Chain("split"), (1, 1, "overlay"), "[UNC0]split[UNC2][L0];[UNC1][L0]overlay[UNC3]"),
        (operator.__rshift__, fgb.Chain("split"), (None, '[over]', "[base][over]overlay"), "[UNC0]split[over][UNC1];[base][over]overlay[UNC2]"),
